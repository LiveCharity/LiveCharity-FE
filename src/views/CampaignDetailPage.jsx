        ...
        <div className="row">
          <div className="col-md-8">
            <div className="image-campaign mx-auto">
              <img
                src="https://asset.ayobantu.com/campaign/HAzeABCB2G_1692847830.jpg"
                alt=""
              />
            </div>
            <div className="description-campaign mt-5 p-3">
              ...
              <p style={{ textAlign: "justify" }}>
                #bantumakan adalah kegiatan kemanusiaan untuk membagikan makanan
                berupa nasi bungkus kepada saudara kita yang kelaparan akibat
                pandemi COVID-19 Walaupun kita sudah memasuki era new normal,
                bukan berarti pandemi telah usai, banyak saudara-saudara kita
                yang saat ini masih kesulitan untuk memenuhi kebutuhan
                sehari-hari. Jangan sampai kita berhenti bergerak dalam membantu
                saudara-saudara kita di masa pandemi ini. Tidak ada kata
                terlambat untuk saling membantu satu sama lain. Sekecil apapun
                bantuanmu, akan berdampak besar bagi mereka. #AyoBantu dukung
                dan berdonasi supaya tercapai 1000 nasi bungkus untuk dibagikan
                kepada mereka yang membutuhkan uluran tangan kita! 1000 nasi
                bungkus ini akan disalurkan ke berbagai daerah dengan angka
                terdampak covid-19 yang masih tinggi.
              </p>
            </div>
          ...
          <div className="col-md-4 detail-right p-3">
            ...
            <div className="d-flex flex-column mb-3 gap-3">
              <h5 style={{ fontSize: 15, textAlign: "center" }}>
                Be a good person, do what you want!
              </h5>
