          ...
          <div className="row">
            <div className="col-6">
              <div className="m-5">
                ...
                <span style={{textAlign:"center", color: "#072366"}}>
                  ...
                  30% of children under the age of 5 are suffering acute
                  malnutrition. <br />The death rate of an area has doubled, or two
                  people (or four children) out of every 10,000 people die each
                  day.
                </span>
              </div>
            </div>
            <div className="col-6">
              <div className="about-img d-flex justify-content-center mt-5">
                <img
                  src="https://themewagon.github.io/charityworks/assets/img/gallery/about1.png"
                  alt="Back Image"
                />
              </div>
            </div>
        ...
        <div className="container">
          <div className="d-flex flex-wrap row mt-5">
            <hr />
                  ...
                  <p style={{color: "#072366"}}>The Distribution of Funds <br />is Carried out Transparently</p>
                    </div>
                    <div style={{textAlign:"center"}} className="card-target">
